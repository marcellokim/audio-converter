...
final class UITestStartupScenario {
    private enum Mode {
        case alwaysReady
...
enum UITestConversionMode {
    case completeSuccess
    case cancelAfterStart
}

final class UITestConversionScenario {
...
final class UITestConversionSession: BatchConversionSessioning {
...
final class UITestSavePanelScenario {
    private enum Mode {
...
enum UITestMergeMode {
    case completeSuccess
    case cancelAfterStart
}

final class UITestMergeScenario {
...
final class UITestMergeSession: BatchConversionSessioning {
    typealias SnapshotHandler = ([BatchStatusSnapshot]) -> Void
...
final class UITestFileSelectionScenario {
    private enum Step {
        case cancel
