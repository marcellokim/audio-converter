...
The current vendored FFmpeg binary has only system runtime dependencies according to `otool -L`, but the build still relies on external codec libraries for MP3 / Opus / Vorbis support. Their corresponding source provenance should stay bundled with the release notes/package:

| Library | Version | Source URL | Source SHA256 |
| --- | --- | --- | --- |
...
| `opus` | `1.6.1` | `https://ftp.osuosl.org/pub/xiph/releases/opus/opus-1.6.1.tar.gz` | `6ffcb593207be92584df15b32466ed64bbec99109f007c82205f0194572411a1` |
| `libvorbis` | `1.3.7` | `https://ftp.osuosl.org/pub/xiph/releases/vorbis/libvorbis-1.3.7.tar.xz` | `b33cc4934322bcbf6efcbacf49e3ca01aadbea4114ec9589d1b1e9d20f72954b` |
| `libogg` | `1.3.6` | `https://ftp.osuosl.org/pub/xiph/releases/ogg/libogg-1.3.6.tar.gz` | `83e6704730683d004d20e21b8f7f55dcb3383cdf84c0daedf30bde175f774638` |
...
- **Still required before release:** bundle the matching FFmpeg + external-library notices/source instructions described in `docs/ffmpeg-licensing.md`, then complete signing/notarization.
